...
@section('content')
    ...
    <div class="sl-mainpanel">
	  ...
	  <form action="{{ url('dashboard/customer/insert/function') }}" method="post"  enctype="multipart/form-data">
		  @csrf
		  <div class="card pd-20 pd-sm-40">
			  ...
			  <div class="form-layout">
				...
				<div class="form-layout-footer">
				  <button class="btn btn-info mg-r-5" type="submit" name="submit" value="insert">Customer Submit</button>
